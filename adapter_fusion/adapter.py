...
from core.constraints import ConstraintType, SketchConstraint
from core.document import SketchDocument, SolverStatus
...
from core.types import Point2D, PointRef, PointType
...
class FusionAdapter(SketchBackendAdapter):
    ...
    def _point2d_to_point3d(self, point) -> Any:
        ...
        """
        from core.types import Point2D
